...
class _MyHomePageState extends State<MyHomePage> with TickerProviderStateMixin {
                      ...
                      builder:
                        ...
                        if (!snapshot.hasData) {
                          ...
                          return GridView(
                            ...
                            // BouncingScrollPhysics 回弹效果的滚动物理学，当到达边缘时会有一些额外的滚动。
  ...
  Widget appBar() {
    /* 
      1. MediaQuery.of(context).platformBrightness 将平台的亮度抓取为布尔值。
      2.如果平台是暗的，那么平台的亮度就是暗的。
      3.如果平台是光，那么平台的亮度就是光。 */
    var brightness = MediaQuery.of(context).platformBrightness;
    bool isLightMode = brightness == Brightness.light;
    return SizedBox(
